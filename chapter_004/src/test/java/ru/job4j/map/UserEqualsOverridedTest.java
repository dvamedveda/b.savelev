...
/**
 * Тесты класса UserEqualsOverrided.
 *
 * @author - b.savelev (mailto: justmustdie@yandex.ru)
 * @version - 1.0
 * @since 0.1
 */
public class UserEqualsOverridedTest {
    ...
    public void whenOverridedOnlyEqualsThenPrintsTwoUser() {
        ...
        User first = new UserEqualsOverrided("Dima", 21, birthday);
        User second = new UserEqualsOverrided("Dima", 21, birthday);
